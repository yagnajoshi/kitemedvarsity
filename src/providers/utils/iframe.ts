...
//import { WKUserScriptWindow,WKUserScriptInjectionTime} from 'cordova-plugin-wkuserscript'; //Yagna - This line replaced by above ling
        ...
        if (platform.is('ios') && win.WKUserScript) {
            platform.ready().then(() => {
                ...
                win.WKUserScript.addScript({
                    ...
                    file: recaptchaPath,
                    //injectionTime: WKUserScriptInjectionTime .END,  //Yagna - This line replaced by above ling
                    injectionTime: 1,
                });
